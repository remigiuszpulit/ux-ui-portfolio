...
function Index(props) {
    const roles = ['UX/UI designer', 'Product Designer', 'UX Strategist', 'Team Player', 'UX Researcher']
...
return (
    ...
    <ReactTypingEffect text={roles} speed={50} eraseSpeed={50} typingDelay={300} eraseDelay={1000}/>
